...
const CareerSection = ({ applyFormRef }) => {
  const scrollToForm = () => {
    if (applyFormRef.current) {
      applyFormRef.current.scrollIntoView({ behavior: 'smooth' }); // Scroll to ApplyForm
    }
  };
  ...
  return (
      <div className="career-section">
        ...
        <div className="career-right">
          ...
          <button onClick={scrollToForm} className="apply-btn">Apply Now</button>
        </div>
      </div>
  );
};
